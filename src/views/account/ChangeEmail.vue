      ...
      >
        ...
        >
          ...
          <div v-if="status==='waiting'">
            <v-card-text>
              На адрес e-mail
              <span>{{ email }}</span> отправлено письмо с ссылкой для подтверждения.
            </v-card-text>
            <v-card-text>
              Ошиблись?
              <a @click="clear">
            ...
            <v-card-text>
              Ссылка не пришла? Проверьте, правильно ли вы указали адрес электронной почты. Посмотрите, не попало ли письмо от нас в "спам".
              <span
                v-if="timeDisplay"
              >
