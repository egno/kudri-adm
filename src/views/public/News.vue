  ...
  section {
    ...
    &.adaptive {
      ...
      .overlay {
        ...
        top: -141px;
        height: 1100px;
        background: url('../../assets/images/news/bg_adaptive.png') right top/contain no-repeat;
      }
      .content {
    ...
    &.connection {
      ...
      .overlay {
        top: 70px;
        background: url('../../assets/images/news/bg_connection.png') right top/contain no-repeat;
      }
      .content {
        .text-wrapper {
          width: 700px;
