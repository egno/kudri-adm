      ...
      <div class="content layer-0">
        <div class="text-wrapper">
          ...
          <p class="text">
            ...
            кабинет в&nbsp;браузере мобильного телефона или планшета и&nbsp;управляйте
            бизнесом из&nbsp;любой точки мира.<br><br>
      ...
      <div class="content">
        <div class="text-wrapper">
          ...
          <p class="text">
            ...
            провести звонок. Или же звоните напрямую через&nbsp;мобильный телефон.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="content">
        <div class="text-wrapper">
          ...
          <div class="subheader">
            ...
            удержать и&nbsp;повысить лояльность
            постоянных клиентов, но и&nbsp;найти новых.
          </div>
          <p class="text">
            Без ставок за&nbsp;привлеченного клиента, процентов с&nbsp;заказов, без&nbsp;штрафов и&nbsp;сложных систем оплат.
            Настройте участие в&nbsp;агрегаторе всего за&nbsp;несколько
    ...
    section {
      ...
      &.aggregation {
        ...
        .g-play {
          ...
          height: 44px;
          margin-top: 55px;
          background: url('../../assets/images/google_play.png') center/contain no-repeat;
          @media screen and (min-width: $tablet) {
            width: 223px;
            height: 80px;
          }
