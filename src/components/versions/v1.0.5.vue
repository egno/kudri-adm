<template>
  <slide>
    <h2 class="main-page__heading">
      <div>Обновления системы версии 1.0.5 от 24.06.2019</div>
      <div>
        <span
          v-for="(indicator, i) in newsIndicators"
          :key="i"
          ...
          <ul>
            ...
            <li class="update-item">
              <p>
                ...
                <router-link :to="{ name: 'faq' }">
                  “Продукт”
                </router-link>и будет всегда доступна для просмотра из страницы информации о вашей компании.
              </p>
            </li>
            <li class="update-item">
              <p>
        ...
        <template slot="content">
          <ul>
            <li class="update-item">
              ...
              <p>Теперь график на день отображает столбцы сотрудников, для улучшения контроля нагрузки салона.</p>
            </li>

            <li class="update-item">
              <h3>Режим графика по умолчанию изменен на “День”</h3>
              <p>Теперь при переходе в журнал записи, в первую очередь вы будете видеть информацию о записях в текущий день, в настоящее время.</p>
            </li>

            <li class="update-item">
              <h3>Закреплено верхнее информационное поле журнала записи</h3>
              <p>Теперь при прокручивании журнала записи вниз, в зависимости от устройства будет отображаться следующая информация:</p>
              <ul>
                <li class="li-text">
                  <h4>Версия для мобильных устройств:</h4>
                  <ul>
                    <li>Отображается информация о выбранном сотруднике.</li>
                  </ul>
                </li>
                <li class="li-text">
